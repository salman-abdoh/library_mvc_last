        ...
        <tbody>
         ...
         <?php foreach($params as $category){?>
          <tr>
            ...
            <td>
            <form class="card-body" action="/status_category" method="POST">
            <a href="/dashbord/edit_category/<?php echo $category['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <input name="category_id" type="text" hidden="hidden" value=<?php echo $category['id'] ; ?> id=""  class="form-control" placeholder="john.doe" />
              <input name="is_active" type="text" hidden="hidden" value=<?php if($category['is_active']==1) {echo 2; }else{ echo 1;} ?> id=""  class="form-control" placeholder="john.doe" />
