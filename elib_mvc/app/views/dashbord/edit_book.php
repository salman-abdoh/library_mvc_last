...
<div class="card mb-12">
  <h5 class="card-header">تعديل كتاب جديد</h5>
  ...
  <div class="row g-3">
      <div class="col-md-6">
        ...
        <input name="book_name" type="text" id="multicol-username"  value=<?php echo $params['book']->title ; ?> class="form-control" placeholder="john.doe" />
        <input name="book_id" type="text" hidden="hidden" value=<?php echo $params['book']->id ; ?> id=""  class="form-control" placeholder="john.doe" />
        </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">عدد الصفحات  </label>
        <input name="book_page" type="number"  value=<?php echo $params['book']->pages_number ; ?> id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  السعر </label>
        <input name="book_price" type="text"  value=<?php echo $params['book']->price ; ?> id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الوصف </label>
        <input name="book_descr" type="text"  value=<?php echo $params['book']->description ; ?> id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> الصيغه </label>
        <input name="book_format" type="text"  value=<?php echo $params['book']->format ; ?> id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> الكميه </label>
        <input name="book_qyt" type="number"  value=<?php echo $params['book']->quantity ; ?> id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <br>
      <div class="row mb-3 select2-primary">
          
          <div class="col-sm-9">
          <select  name="selected_cats"  id="multicol-language" class="form-control">
             
    <?php
    foreach($params['categories'] as $cats){ ?>
<option <?php if($params['book']->category_id==$cats['id']) {echo 'selected'; }else{ } ?> value="<?= $cats['id'];?>"><?= $cats['name'] ;?></option>
   ...
   <?php  } 
    ?>
        ...
        <div class="row mb-3 select2-primary">         
          <div class="col-sm-9">
          <select  name="selected_auth"  id="multicol-language" class="form-control">          
    <?php
    foreach($params['authers'] as $auth){ ?>
   ...
   <?php  } 
    ?>            </select>
        ...
        <div class="row mb-3 select2-primary">
          ...
          <div class="col-sm-9">
            <select  name="selected_pup"  id="multicol-language" class="form-control">
             
    <?php
    foreach($params['publishers'] as $pup){ ?>
<option value="<?= $pup['id'];?>"><?= $pup['name'] ;?></option>
   <?php  } 
    ?>
            </select>
          </div>
      ...
      <div class="col-md-6">
        ...
        <input  name="oldimage" type="text" value=<?php echo $params['book']->image ; ?>  class="form-control"  aria-describedby="multicol-email2" />
