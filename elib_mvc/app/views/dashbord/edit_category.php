...
<div class="card mb-12">
  ...
  <div class="row g-3">
      <div class="col-md-6">
        ...
        <input name="category_name" type="text" id="multicol-username"  value=<?php echo $params['categories']->name ; ?> class="form-control" placeholder="john.doe" />
        <input name="category_id" type="text" hidden="hidden" value=<?php echo $params['categories']->id ; ?> id=""  class="form-control" placeholder="john.doe" />
        </div>
      ...
      <div class="col-md-6">
        ...
        <input  name="oldimage" type="text" value=<?php echo $params['categories']->image ; ?>  class="form-control"  aria-describedby="multicol-email2" />
