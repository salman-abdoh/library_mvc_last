         ...
         <?php foreach($params as $book){?>
          ...
          <tr>
            ...
            <td>
              ...
              <form class="card-body" action="/status_book" method="POST">
              <a href="/dashbord/edit_book/<?php echo $book['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <input name="book_id" type="text" hidden="hidden" value=<?php echo $book['id'] ; ?> id=""  class="form-control" placeholder="john.doe" />
              <input name="is_active" type="text" hidden="hidden" value=<?php if($book['is_active']==1) {echo 2; }else{ echo 1;} ?> id=""  class="form-control" placeholder="john.doe" />
