...
<div class="card mb-12">
  ...
  <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input name="book_page" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  السعر </label>
        <input name="book_price" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الوصف </label>
        <input name="book_descr" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> الصيغه </label>
        <input name="book_format" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> الصيغه </label>
        <input name="book_qyt" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <br>
