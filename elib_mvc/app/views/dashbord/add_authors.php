...
<div class="card mb-4" style="    text-align: inherit;
    direction: rtl;" >
  <h5 class="card-header">انشاء قسم جديد</h5>
  <form class="card-body" action="/save_authors" method="POST" enctype="multipart/form-data">
    
    <div class="row g-6">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">اسم المولف </label>
      ...
      <div class="col-md-6">
        ...
        <input name="auther_email" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      
      <div class="col-md-6 ">
        <label class="form-label" for="multicol-username">رقم الهاتف </label>
        <input name="auther_phone" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">مدري </label>
        <input name="auther_bio" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      
      
      </div>
      
      <div class="col-md-1" style="    direction: initial;">
    ...
    <div class="pt-4" style="    direction: ltr;">
