    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        ...
        <tbody>
         ...
         <?php foreach($params as $puplisher){?>
          <tr>
            
            <td><?= $puplisher['name'];?></td>
            <td><?= $puplisher['phone'];?></td>
            <td><?= $puplisher['fax'];?></td>
            <td><?= $puplisher['email'];?></td>
            <td><?= $puplisher['address'];?></td>
            <td>
              <img class="img-fluid rounded" height="150px" width="150px" src="/../../images/<?= $puplisher['image'];?>">
            </td>
            <td>
            <?php if($puplisher['is_active']==1) {?>    
            ...
            <td>
            <a href="/dashbord/edit_puplisher/<?php echo $puplisher['id'];?>" class="btn btn-icon btn-outline-dribbble">
