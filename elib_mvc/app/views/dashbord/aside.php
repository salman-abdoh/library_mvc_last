...
<li class="menu-item">
  ...
  <li class="menu-item">
  <a href="/dashbord/add_category" class="menu-link">
    <div>انشاء قسم</div>
  </a>
</li>
<li class="menu-item">
  <a href="/dashbord/categories" class="menu-link">
    <div>عرض الاقسام</div>
  </a>
</li>
  ...
  <li class="menu-item">
  <a href="/dashbord/add_book" class="menu-link">
    <div>انشاء كتاب جديد</div>
  </a>
</li>
<li class="menu-item">
  <a href="/dashbord/books" class="menu-link">
    <div>عرض الكتب</div>
  </a>
</li>
<li class="menu-header small text-uppercase"><span class="menu-header-text">ادارة المؤلفين</span></li>
  <li class="menu-item">
  <a href="/dashbord/add_authors" class="menu-link">
    <div>انشاء مؤلف</div>
  </a>
</li>
...
<li class="menu-item">
  <a href="/dashbord/authors" class="menu-link">
...
<li class="menu-header small text-uppercase"><span class="menu-header-text">ادارة الناشرين</span></li>
  <li class="menu-item">
  <a href="/dashbord/add_puplisher" class="menu-link">
    <div>انشاء ناشر</div>
  </a>
</li>
<li class="menu-item">
  <a href="/dashbord/puplisher" class="menu-link">
...
<li class="menu-header small text-uppercase"><span class="menu-header-text">ادارة العناوين</span></li>
  <li class="menu-item">
  <a href="/dashbord/add_adress" class="menu-link">
    <div>انشاء عنوان</div>
  </a>
</li>
<li class="menu-item">
  <a href="/dashbord/address" class="menu-link">
