...
<div class="card mb-12">
  ...
  <form class="card-body" action="/save_puplisher" method="POST" enctype="multipart/form-data">
    
  <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">اسم الناشر</label>
        <input name="puplisher_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
        </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">رقم الهاتف الناشر</label>
        <input name="puplisher_phone" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">رقم هاتف اضافي </label>
        <input name="puplisher_alt_phone" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">رقم الفاكس</label>
        <input name="puplisher_fax" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> البريد الالكتروني</label>
        <input name="puplisher_email" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> العنوان </label>
        <input name="puplisher_address" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
     
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> الدولة </label>
        <input name="puplisher_country" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
