      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y" style="direction: rtl;">
            ...
            <!-- Bordered Table -->
<div class="card">
  <h5 class="card-header">المؤلفون</h5>
  <div class="card-body">
        ...
        <tbody>
         ...
         <?php foreach($params as $authers){?>
          <tr>
            ...
            <td>
            <a href="/edit_authers/<?php echo $authers['id'];?>" class="btn btn-icon btn-outline-dribbble">
