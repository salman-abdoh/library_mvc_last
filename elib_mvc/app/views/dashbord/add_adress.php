...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_category" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الدوله </label>
        <input name="address_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
